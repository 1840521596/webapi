...
结果查看地址: {report_url}""".format(env_flag=env_flag, env_num=env_num,
    ...
    params = {"tos":"guohongjie,renhuihui,zhaohongling,pengjunxia,wangmengxiao,hongchen,tianningxue,liushuang,xuhongying,panze,jiayujiao,{developer}".format(developer=developer),
